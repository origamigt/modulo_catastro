 ...
 */
package com.origami.sgmee.catastro.procesos.crear;
...
/**
 * Permite inicar la tarea de crear predio. (No usada)
 *
 * @author dfcalderio
 */
@Named(value = "iniciarCrearFlow")
@ViewScoped
public class IniciarCrear extends BpmManageBeanBaseRoot implements Serializable {
    ...
    public void iniciarTramite() {
        ...
        try {
            GeTipoTramite tipoTramite = this.getGeTipoTramiteByActivitiKey("process_crearPredio");
            if (tipoTramite == null) {
