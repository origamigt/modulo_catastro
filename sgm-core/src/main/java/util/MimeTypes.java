...
/**
 * Contiene los diferente tipos de archivos. y el mine de aplicacion.
 *
...
public class MimeTypes {
    ...
    public static final String MIME_MICROSOFT_WORD_DOCX = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
    public static final String MIME_MSEXCEL_XLSX = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
...
//                    throw new IllegalArgumentException("Duplicated extension: " + key);
...

            {
                ...
                put1(MIME_VIDEO_VND_MPEGURL, "mxu");
                ...
                put1(MIME_MODEL_MESH, "silo");
                put1(MIME_MODEL_MESH, "mesh");
                put1(MIME_MODEL_MESH, "msh");
                put1(MIME_MODEL_IGES, "iges");
                put1(MIME_MODEL_IGES, "igs");
                ...
                put1(MIME_AUDIO_X_AIFF, "aifc");
                put1(MIME_AUDIO_X_AIFF, "aif");
                put1(MIME_AUDIO_X_AIFF, "aiff");
                put1(MIME_AUDIO_MPEG, "mp3");
                put1(MIME_AUDIO_MPEG, "mp2");
                put1(MIME_AUDIO_MPEG, "mp1");
                put1(MIME_AUDIO_MPEG, "mpga");
                put1(MIME_AUDIO_MIDI, "kar");
                put1(MIME_AUDIO_MIDI, "mid");
                put1(MIME_AUDIO_MIDI, "midi");
                put1(MIME_APPLICATION_XML_DTD, "dtd");
                put1(MIME_APPLICATION_XML, "xsl");
                ...
                put1(MIME_APPLICATION_X_TROFF, "tr");
                put1(MIME_APPLICATION_X_TROFF, "t");
                ...
                put1(MIME_APPLICATION_X_KOAN, "skt");
                put1(MIME_APPLICATION_X_KOAN, "skd");
                ...
                put1(MIME_APPLICATION_X_DIRECTOR, "dxr");
                ...
                put1(MIME_APPLICATION_OCTET_STREAM, "lzh");
                put1(MIME_APPLICATION_OCTET_STREAM, "so");
                put1(MIME_APPLICATION_OCTET_STREAM, "lha");
                put1(MIME_APPLICATION_OCTET_STREAM, "dms");
                put1(MIME_APPLICATION_OCTET_STREAM, "bin");
                ...
                put1(MIME_TEXT_PLAIN, "ini");
                put1(MIME_TEXT_PLAIN, "c");
                put1(MIME_TEXT_PLAIN, "h");
                put1(MIME_TEXT_PLAIN, "cpp");
                put1(MIME_TEXT_PLAIN, "cxx");
                put1(MIME_TEXT_PLAIN, "cc");
                put1(MIME_TEXT_PLAIN, "chh");
                put1(MIME_TEXT_PLAIN, "java");
                put1(MIME_TEXT_PLAIN, "csv");
                put1(MIME_TEXT_PLAIN, "bat");
                put1(MIME_TEXT_PLAIN, "cmd");
                put1(MIME_TEXT_PLAIN, "asc");
                ...
                put1(MIME_APPLICATION_X_GZIP, "gz");
     ...
     * @param mimeType
     */
    public static void registerMimeType(String mimeType, String ext) {
    ...
    /**
     * Returns la extension de Mime type correspondiente.
     *
     * @param mimeType
     * @return
     */
    public static String getMimeType(String mimeType) {
        String ext = lookupMimeType(mimeType);
        if (ext == null) {
            ext = lookupMimeType(MIME_APPLICATION_OCTET_STREAM);
        }
        return ext;
    }

    /**
     * retorna la extension del MIME type, si no lo encuentra retorna null.
     *
     * @param mimeType
     * @return
     */
    ...
    public static String getMimeTypeForExtension(String extensionFile) {
        for (Map.Entry<String, String> entry : mimeTypeMapping.entrySet()) {
            String key = entry.getKey();
            String value = entry.getValue();
            if (extensionFile.equalsIgnoreCase(value)) {
                return key;
            }
        }
