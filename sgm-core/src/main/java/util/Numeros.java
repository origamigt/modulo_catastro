...
/**
 * Tiene metodos que permiten convertir los numeros a letras.
 *
 * @author dfcalderio
 */
public class Numeros {
    ...
    public static String convertNumberToLetter(double doubleNumber)
        ...
        if (valor.length() == 1) {
            converted.append("DOLARES CON ").append(splitNumber[1]).append("0").append("/100 ");
        } else {
            converted.append("DOLARES CON ").append(splitNumber[1]).append("/100 ");
        }
